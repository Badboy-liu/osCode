...
%endrep
.020h:
	dw ClockHandler	;会定义中断响应函数的地址
	dw SelectoerCode32
	dw 08E00h
	dw((ClockHandler >> 16) & 0FFFFh)
%rep 95
	dw NormalHandler	;会定义中断响应函数的地址
	dw SelectoerCode32
	dw 08E00h
...
%endrep
.080h:
	dw UserHandler	;会定义中断响应函数的地址
	dw SelectoerCode32
	dw 08E00h
	dw((UserHandler >> 16) & 0FFFFh)
IdtLen equ $ - PM_IDT
IdtPtr dw IdtLen - 1
	dd 0
;End of idt
...
ClockHandler equ _ClockHandler - $$
	;inc byte [gs:((80 * 1 + 75)*2)]
	
	;获取CMOS时钟，然后我们希望奇数秒打印D，偶数秒打印X
	mov al,0	;获取了当前的秒
	out 70h,al
	in  al,71h
	mov ah,al
