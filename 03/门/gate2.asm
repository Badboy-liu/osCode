...
SelectoerCallGateTest equ PM_CALL_GATE_TEST - PM_GDT	+ SA_RPL3	
SelectoerCodeRing3 equ PM_DESC_CODE_RING3-PM_GDT+SA_RPL3
SelectoerStack3 equ PM_DESC_STACK3-PM_GDT+SA_RPL3
SelectoerTSS equ PM_DESC_TSS-PM_GDT
...
.2: ;显示完毕
	...
	;beging gate 2:特有级别转换
	;load TSS
	mov ax,SelectoerTSS
	ltr ax

	push SelectoerStack3
	push TopOfStack3
	push SelectoerCodeRing3
	push 0
	retf
	;jmp $
...
PM_CODE_RING3:
	...
	call SelectoerCallGateTest:0 ;调用门完成特权级切换
	jmp $
